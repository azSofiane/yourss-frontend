                ...
                <Card className='card-profil'>
                  <Row gutter={[12, 12]}>
                    ...
                    <Col span={24} md={10} className='text-center'>
                      {
                        ((formData.date_de_debut || formData.date_de_fin ) || editProfil) &&
                        <>
                          <h2>Date de stage</h2>

                          {
                            editProfil ?
                              <>
                                <DatePicker size='large' placeholder='Date de début' format={dateFormat} onChange={(e) => setFormDataPreview({ ...formDataPreview, date_de_debut: e.toDate() })} className='mx-2' />

                                <DatePicker size='large' placeholder='Date de fin' format={dateFormat} onChange={(e) => setFormDataPreview({ ...formDataPreview, date_de_fin: e.toDate() })} className='mx-2' />
                              </>
                            :
                            <>
                              {dayjs(formData.date_de_debut).format(dateFormat)} <FontAwesomeIcon icon={ faAngleRight } className="mx-3" /> {dayjs(formData.date_de_fin).format(dateFormat)}
                            </>
                          }
                        </>
                      }
