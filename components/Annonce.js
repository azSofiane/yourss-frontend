...
function Annonce({ props }) {
  ...
  const handleCreationAnnonce = () => {
    fetch("http://localhost:3000/annonces/", {
      ...
      body: JSON.stringify({
        date_de_creation: creationDateCreation,
        date_de_publication: creationDatePublication,
        date_de_debut: creationDateDebut,
        date_de_fin: creationDateFin,
        titre: creationTitre,
        archive: archiver,
        ville: creationVille,
        code_postal: creationCodePostal,
        adresse: creationAdresse,
        profession: creationPoste,
        entreprise: creationEntreprise,
                    ...
                    <Col span={24}>
                      {test ? (
                        <Input
                          placeholder="Titre"
                          size="large"
                          onChange={(e) => setCreationTitre(e.target.value)}
                          value={creationTitre}
                        />
                      ) : (
                        props.creationTitre
                    ...
                    <Col span={24}>
                      {test ? (
                        <DatePicker
                          ...
                          onChange={(date) => setCreationDatePublication(date)}
                          value={creationDatePublication}
                        />
                      ) : (
                        dayjs(props.creationDatePublication).format(dateFormat)
                      )}
                    </Col>
                    ...
                    <Col span={24}>
                      ...
                      {test ? (
                        <DatePicker
                          ...
                          onChange={(date) => setCreationDateDebut(date)}
                          value={creationDateDebut}
                        />
                      ) : (
                        dayjs(props.creationDateDebut).format(dateFormat)
                      )}
                    </Col>
                    ...
                    <Col span={24}>
                      ...
                      {test ? (
                        <DatePicker
                          ...
                          onChange={(date) => setCreationDateFin(date)}
                          value={creationDateFin}
                        />
                      ) : (
                        dayjs(props.creationDateFin).format(dateFormat)
                      )}
                    </Col>
                    ...
                    <Col span={24}>
                      {test ? (
                        <Input
                          placeholder="Poste"
                          size="large"
                          onChange={(e) => setCreationPoste(e.target.value)}
                          value={creationPoste}
                        />
                      ) : (
                        props.creationPoste
                    ...
                    <Col span={24}>
                      {test ? (
                        <Input
                          ...
                          size="large"
                          onChange={(e) =>
                            setCreationEntreprise(e.target.value)
                          }
                          value={creationEntreprise}
                        />
                      ) : (
                        creationEntreprise
                      )}
                    ...
                    <Col span={24}>
                      {test ? (
                        <Input
                          placeholder="Ville"
                          size="large"
                          onChange={(e) => setCreationVille(e.target.value)}
                          value={creationVille}
                        />
                      ) : (
                        props.creationVille
                    ...
                    <Col span={24}>
                      {test ? (
                        <Input
                          placeholder="Adresse"
                          size="large"
                          onChange={(e) => setCreationAdresse(e.target.value)}
                          value={creationAdresse}
                        />
                      ) : (
                        props.creationAdresse
                      )}
                    </Col>
                    ...
                    <Col span={24}>
                      {test ? (
                        <Input
                          ...
                          size="large"
                          onChange={(e) =>
                            setCreationCodePostal(e.target.value)
                          }
                          value={creationCodePostal}
                        />
                      ) : (
                        props.creationCodePostal
                      )}
                    </Col>
