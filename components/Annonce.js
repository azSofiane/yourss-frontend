              ...
              <Col span={24}>
                <Card>
                  <Row gutter={[12, 12]}>
                    ...
                    <Col span={24}>{ test ? <DatePicker defaultValue={dayjs('01/01/2015', dateFormatList[0])} format={dateFormatList} size="large" placeholder="Date Publication" onChange={(date, dateString) => setCreationDatePublication(date)} value={creationDatePublication}/>: 'Date de publication' }</Col>

                    <Col span={24}> {test ? <DatePicker defaultValue={dayjs('01/01/2015', dateFormatList[0])} format={dateFormatList} size="large" placeholder="Date Début" onChange={(date, dateString) => setCreationDateDebut (date)} value={creationDateDebut}/> : 'Date de début'}</Col>
